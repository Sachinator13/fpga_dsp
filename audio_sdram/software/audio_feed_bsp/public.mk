...
SOPCINFO_FILE := c:/repos/fpga_pedal/audio_sdram/audio_feed.sopcinfo
...
# Design Name 
# setting SOPC_NAME is audio_feed
SOPC_NAME := audio_feed
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1755780044
SOPC_SYSID_FLAG += --timestamp=1755780044
ELF_PATCH_FLAG  += --timestamp 1755780044
