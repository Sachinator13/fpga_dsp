	audio_feed u0 (
		...
		.audio_clock_export_clk                   (<connected-to-audio_clock_export_clk>),                   //                audio_clock_export.clk
		...
		.final_audio_external_connection_export   (<connected-to-final_audio_external_connection_export>),   //   final_audio_external_connection.export
		...
		.init_audio_external_connection_export    (<connected-to-init_audio_external_connection_export>),    //    init_audio_external_connection.export
		...
		.final_audio_3_external_connection_export (<connected-to-final_audio_3_external_connection_export>), // final_audio_3_external_connection.export
		.final_audio_2_external_connection_export (<connected-to-final_audio_2_external_connection_export>), // final_audio_2_external_connection.export
		.final_audio_4_external_connection_export (<connected-to-final_audio_4_external_connection_export>)  // final_audio_4_external_connection.export
	);
