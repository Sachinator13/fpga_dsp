...
#
# Script generated by Vivado on Sun Aug 24 22:26:03 +0100 2025
...
#
# Usage        : fir_tb.sh
#                fir_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fir_tb.sh [-reset_run]
#                fir_tb.sh [-reset_log]
#                fir_tb.sh [-help]
#
...
# script info
echo -e "fir_tb.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fir_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_10 c_addsub_v12_0_20 mult_gen_v12_0_23 axi_utils_v2_0_10 cordic_v6_0_24)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fir_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fir_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fir_tb.sh [-help]\n\
Usage: fir_tb.sh [-step]\n\
Usage: fir_tb.sh [-lib_map_path]\n\
Usage: fir_tb.sh [-reset_run]\n\
Usage: fir_tb.sh [-reset_log]\n\
Usage: fir_tb.sh [-keep_index]\n\
Usage: fir_tb.sh [-noclean_files]\n\n\
